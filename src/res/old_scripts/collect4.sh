...
tile_sizes=(4 5 6)
matrix_sizes=(36000 48000 72000 96000)
# T=6
# N=24000
sm_count=20
        ...
        then 
            ...
            for ((g = 1 ; g <= 4 ; g++ )); do
                ...
                if [[ $g =~ $skip_gpu_regex ]]; then
                    ...
                    # if [ $method -eq -1 ] || [ $method -eq 4 ]; then $MG_SAMPLES_DIR/cusolver_MgGetrf_example -N=$N -B=100 -r=$runs >> $outfolder/log3_$N\_$T\_$g\GPU.log ; fi
